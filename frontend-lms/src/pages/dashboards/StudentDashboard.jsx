      ...
      <main className="ml-64 flex-1 flex flex-col min-h-screen">
        <header className="bg-white border-b border-slate-200 px-8 py-6 flex items-center justify-between sticky top-0 z-10">
          ...
          <div className="flex items-center gap-4">
            <span className="font-bold text-slate-900">Welcome, {localStorage.getItem("username")||"Learner"}</span>
          </div>
        </header>
        ...
        <div className="p-8 flex-1">
          <div className="bg-white p-12 rounded-2xl border border-slate-200 shadow-sm text-center">
            ...
            <p className="text-slate-500 text-sm max-w-sm mx-auto">This section is currently under development. You can access your enrolled courses and learning resources here.</p>
          </div>
        </div>
      </main>
    </div>
