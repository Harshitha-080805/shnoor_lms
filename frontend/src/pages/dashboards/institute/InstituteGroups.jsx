              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full px-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 resize-none h-24"
          ...
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-xl flex flex-col">
            ...
            <div className="p-6 overflow-y-auto flex-1">
              <div className="mb-4 flex items-center gap-2">
                 <input type="text" placeholder="Search users..." className="flex-1 px-3 py-2 border rounded-md text-sm" />
              </div>
