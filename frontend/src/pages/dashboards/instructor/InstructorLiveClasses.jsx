    ...
    <div className="space-y-8 animate-fade-in-up">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-blue-950 p-6 rounded-2xl shadow-md relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-1">
          ...
          <p className="text-blue-100 font-medium text-sm max-w-xl">
            Schedule and manage virtual learning sessions seamlessly.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center shadow-sm">
          ...
          <p className="text-slate-500 text-sm max-w-md mx-auto mb-6">You haven't scheduled any virtual sessions. Start by creating a live class for your enrolled students.</p>
          <button
            onClick={() => handleOpenModal()}
                ...
                <div className="p-6 flex-1 flex flex-col">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button onClick={() => handleOpenModal(cls)} className="p-1.5 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                        <Edit size={16} />
                      </button>
                  ...
                  <div className="flex gap-3 mt-auto">
                    {displayStatus !== 'Completed' && displayStatus !== 'Cancelled' && (
                      ...
                      >
                        {cls.instructor_id === parseInt(sessionStorage.getItem('userId')) ? 'Start Meeting' : 'Join Meeting'} <ExternalLink size={16} />
                      </a>
                    )}
                    {cls.recording_link && (
                       <a
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="md:col-span-2">
                    ...
                    <select
                      ...
                      className="w-full bg-slate-50 border border-slate-200 text-slate-900 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent p-3 outline-none transition font-medium"
                    >
